...
<h1 style="color:black;font-size:80px"" align="center">ADICIONAR - ATOR</h1>
...
<div id="local">
  ...
  <br>  <textarea name="biografia" cols="10" rows="1" style="width: 35%;
    padding: 12px 20px;
    margin: 8px 0;
    ...
    <input type="text" id="nascimento" name="nascimento" placeholder="DIGITE O ANO, MES E DIA" style="width:250px"><br><br>
...
<%}else{%>
	<h1 style="margin-left:450px; margin-top:200px; font-size:40px">EDITORES SOMENTE!</h1>
<%}%>
</body>
</html>